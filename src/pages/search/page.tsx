...
import { IconMoodSad, IconCheese } from "@tabler/icons-react";
        ...
        <Group position="left" my="lg">
          {nutrients.macronutrients.map(({ value, label }) => (
            <Popover width={300} position="bottom" shadow="md">
              ...
              <Popover.Dropdown>
                <Text size="xs" mb="md">
                  Choose minimum and maximum values for a desired nutrient per
                  serving. For individual foods, the default serving size is 100
                  g
                </Text>
  ...
  hits: [
        ...
        ingredients: [
          {
            ...
            image:
              "https://www.edamam.com/food-img/ee9/ee9566349cb84dfd9ddac1fdf8cbc907.jpg",
          },
          {
            text: "1 cup sugar",
            quantity: 1.0,
        ...
        ingredients: [
          {
            ...
            image:
              "https://www.edamam.com/food-img/23a/23ad491827f58ce949c582bbb13a9c12.jpg",
          },
          {
    ...
    },
    {
      recipe: {
        ...
        shareAs:
          "http://www.edamam.com/recipe/coffee-e595ea25d81017c6d6c371129f94833a/coffee",
        yield: 6.0,
        dietLabels: ["Low-Fat", "Low-Sodium"],
        healthLabels: [
          "Sugar-Conscious",
    ...
    },
    {
      recipe: {
        ...
        shareAs:
          "http://www.edamam.com/recipe/iced-coffee-c342e720f679cd098295ccb7baad655b/coffee",
        yield: 2.0,
        dietLabels: ["Low-Sodium"],
        healthLabels: [
          "Sugar-Conscious",
      ...
      recipe: {
        ...
        ingredients: [
          ...
          },
          {
            ...
            image:
              "https://www.edamam.com/food-img/8e7/8e7bdc6077d53235955dca584b2ba568.jpg",
          },
          {
